    ...
    <>
      <div className="contact p-5 d-flex flex-column justify-content-around">
        <div className="contact-top d-flex pt-5 px-3 align-items-center">
          <div className="contact-text ">Reach out to us</div>
        </div>
        <div className="contact-foot  mt-4 mb-5 mx-3">
          <div className="contact-mail mb-4 d-flex align-items-center">
            ...
            <div className="mail-text mx-2">
              ...
              <p className="mb-0">Quick response guaranteed.</p>
            </div>
          </div>
          <div className="contact-call d-flex align-items-center">
            ...
            <div className="contact-text mx-2 ">
              ...
              <p className="mb-0">For quick assistance, call us .</p>
            </div>
          </div>
        </div>
        <div className="icons d-flex justify-content-between align-items-center">
          <div
            onClick={handleMsg}
            className={`msg-icon trans-icons py-1 px-2 ${
              locationClicked ? "msg-size" : ""
            } `}
          >
          ...
          <div
            ...
            className={`location-icon trans-icons py-1 px-2 ${
              !locationClicked ? "location-size" : ""
            }`}
          >
        ...
        >
          ...
          <div className={`message ms-3 `}>
            <div className="message-text py-3 text-center">
              <div className="send1">Send us a message!</div>
              <div className="send2">How can we help you today?</div>
            </div>
                ...
                <form type="submit">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={onchange}
                      value={message.name}
                      className="contact-form form-control contact-control"
                      id="name"
                    />
                  </div>
                  <div className="mb-3">
        ...
        <div className="contact-left text-center d-flex align-items-center"></div>
      </div>
