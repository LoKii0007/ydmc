    ...
    <>
      <div className="sellCar">
        <div className="sell-div-1 p-5">
          <div className="sell-head text-center mb-5">
            ...
            <h2 style={{ color: "green" }}>
              with few <span style={{ color: "green" }}>simple</span> steps
            </h2>
            <img className="sell-img" src="/porsche-model.png" alt="" />
          </div>
          <div className="sell-footer d-flex flex-column justify-content-center">
            <div className="sell-details mb-2">
            ...
            <button className="sell-app sell-btn mb-3 py-2">
              Chat On Whatsapp
            </button>
        ...
        <div className="sell-div-2 p-5">
          <div className="sell-div-2-inner">
